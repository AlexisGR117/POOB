...
public class Canvas{
    ...
    public static final String[] colors = {"red", "orange", "yellow", "green", "cyan", "magenta", "pink", "white", "lightGray", "gray", "darkGray", "blue", "black"};
    /**
     * Dice si el color dado se puede usar.
     * @param color Color que se desea saber si está dentro de las opciones de Canvas.
     * @return Valor boolean que dice si el color dado se puede usar.
     */
    public static boolean existColor(String color){
        boolean in = false;
        for (int i = 0; i < colors.length && !in; i++){
