...
public class Tablero implements Serializable {
	...
	private Ficha seleccion, ultimaSeleccion;
	...
	private boolean seleccionFicha, seleccionComodin;
	/**
	...
	public boolean moverSeleccion(int f, int c) throws DAPOOSException {
		...
		if (comodinActivo == null && (captura == false || (captura == true && seleccion.numeroSaltosPosibles() == 0))) {
			...
			deseleeccionar();
			if (comodinActivo instanceof OneMoreTime || comodinActivo instanceof Infinity) comodinActivo.activar();
	...
	public String toString() {
	   ...
	   public void activarSeleccionFicha() {
		   seleccionFicha = true;
	   }
	   
	   public void activarSeleccionComodin() {
		   seleccionFicha = true;
	   }
	   
	   public boolean seleccionFicha() {
		   return seleccionFicha;
	   }
	   
	   public boolean seleccionComodin() {
		   return seleccionFicha;
	   }
	   
	   public Ficha ultimaSeleccion() {
